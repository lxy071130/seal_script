/* 本文件基于 https://github.com/sealdice/javascript/blob/main/examples_ts/seal.d.ts
   用于消除TypeScript缺少依赖报错，在此基础上添加了seal.deck.draw等方法 */
declare namespace seal {
    ...
    /** 运行dicescript */
    export function format(ctx: MsgContext, str: string): string;

    export const deck: {
        /** 抽卡 */
        draw(ctx: MsgContext, deck: string, isShuffle: boolean): Map<string, string>;
        /** 重载牌堆 */
        reload();
    }
